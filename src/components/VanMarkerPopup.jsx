    ...
    <div className="font-inter min-w-[210px]">
      ...
      <div className="flex gap-1.5">
        <a
          href={googleMapsUrl}
          target="_blank"
          rel="noopener noreferrer" className="text-[hsl(var(--destructive))] px-2 py-1.5 text-xs font-semibold opacity-100 rounded-lg flex-1 flex items-center justify-center gap-1"
