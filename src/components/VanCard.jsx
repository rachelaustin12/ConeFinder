          ...
          <div className="flex-1 min-w-0">
            ...
            {van.specialties &&
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <button
                  onClick={() => setShowMessage(true)} className="bg-[#f5a8c3] text-[hsl(var(--secondary))] text-base font-thin flex items-center gap-1 hover:text-primary/80 transition-colors">
