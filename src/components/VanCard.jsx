          ...
          <div className="flex-1 min-w-0">
            ...
            {van.specialties &&
              <div className="flex flex-wrap gap-1 mt-2">
                ...
                <Badge key={i} variant="secondary" className="bg-[#d9e1fc] text-[#ffffff] px-1.5 py-0 font-body opacity-100 rounded-md inline-flex items-center border transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent hover:bg-secondary/80">
                      {s.trim()}
                    </Badge>
                )}
                </div>
